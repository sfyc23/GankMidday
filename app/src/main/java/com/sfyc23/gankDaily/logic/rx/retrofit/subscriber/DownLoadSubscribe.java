package com.sfyc23.gankDaily.logic.rx.retrofit.subscriber;
...
import com.sfyc23.gankDaily.base.utils.FileUtils;
...
public abstract class DownLoadSubscribe extends Subscriber<ResponseBody> {
    ...
    public DownLoadSubscribe(@NonNull String fileName) {
        mSaveFilePath = FileUtils.getCacheDir(BaseApplication.getAppContext()).getAbsolutePath();
